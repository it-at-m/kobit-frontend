...
import { ContactResponse } from "@/features/commons/types/contact.type";
import { LinkResponse } from "@/features/commons/types/link.type";
import AnlaufstelleService from "@/features/the-unterstuetzungsfinder/features/the-contact-points/the-contact-points-service.api";
import Anlaufstelle, {
  AnlaufstelleMinified,
  AnlaufstelleResponse,
} from "@/features/the-unterstuetzungsfinder/features/the-contact-points/types/anlaufstelle.type";

export const THE_ANLAUFSTELLEN_MODULE_NAME = "theAnlaufstellenStoreModule";
const THE_ANLAUFSTELLEN_GETTER_GET_ANLAUFSTELLEN_MINIFIED =
  "THE_ANLAUFSTELLEN_GETTER_GET_ANLAUFSTELLEN_SHORT";
const THE_ANLAUFSTELLEN_GETTER_GET_ANLAUFSTELLEN =
  "THE_ANLAUFSTELLEN_GETTER_GET_ANLAUFSTELLEN";
const THE_ANLAUFSTELLEN_MUTATION_INIT_ANLAUFSTELLEN =
  "THE_ANLAUFSTELLEN_MUTATION_INIT_ANLAUFSTELLEN";
const THE_ANLAUFSTELLEN_MUTATION_SET_ANLAUFSTELLEN =
  "THE_ANLAUFSTELLEN_MUTATION_SET_ANLAUFSTELLEN";
const THE_ANLAUFSTELLEN_ACTION_SET_ANLAUFSTELLEN =
  "THE_ANLAUFSTELLEN_ACTION_SET_ANLAUFSTELLEN";
const THE_ANLAUFSTELLEN_MUTATION_SET_CONTACTS =
  "THE_ANLAUFSTELLEN_MUTATION_SET_CONTACTS";
const THE_ANLAUFSTELLEN_MUTATION_SET_LINKS =
  "THE_ANLAUFSTELLEN_MUTATION_SET_LINKS";
const THE_ANLAUFSTELLEN_ACTION_INIT_STATE =
  "THE_ANLAUFSTELLEN_ACTION_INIT_STATE";
const THE_ANLAUFSTELLEN_MUTATION_SET_API_STATE =
  "THE_ANLAUFSTELLEN_MUTATION_SET_API_STATE";
const THE_ANLAUFSTELLEN_GETTER_GET_API_STATE =
  "THE_ANLAUFSTELLEN_GETTER_GET_API_STATE";
...
export const theAnlaufstellenStoreModule = {
  ...
  mutations: {
    [THE_ANLAUFSTELLEN_MUTATION_INIT_ANLAUFSTELLEN](
      state: TheAnlaufstellenStoreState,
      anlaufstellen: AnlaufstelleResponse[]
    ): void {
  ...
  actions: {
    async [THE_ANLAUFSTELLEN_ACTION_INIT_STATE]({
      commit,
      dispatch,
    ...
    [THE_ANLAUFSTELLEN_ACTION_SET_ANLAUFSTELLEN]({
      commit,
    }: ActionContext<unknown, unknown>): void {
      commit(THE_ANLAUFSTELLEN_MUTATION_SET_API_STATE, Loading.INIT);
      commit(THE_ANLAUFSTELLEN_MUTATION_SET_API_STATE, Loading.LOADING);
  ...
  getters: {
    [THE_ANLAUFSTELLEN_GETTER_GET_ANLAUFSTELLEN](
      ...
      const sortedAnlaufstellen = JSON.parse(
        JSON.stringify(state.anlaufstellen)
      );
      return sortedAnlaufstellen.sort(
        (a: { name: string }, b: { name: string }) =>
          a.name.localeCompare(b.name)
      );
    },
    [THE_ANLAUFSTELLEN_GETTER_GET_ANLAUFSTELLEN_MINIFIED](
      state: TheAnlaufstellenStoreState
    ): AnlaufstelleMinified[] {
      ...
      state.anlaufstellen.forEach((anlaufstelle) => {
        ...
        minifiedAnlaufstelle.shortCut = anlaufstelle?.shortCut
          ? anlaufstelle.shortCut
          : "";
        minifiedAnlaufstelle.department = anlaufstelle?.department
