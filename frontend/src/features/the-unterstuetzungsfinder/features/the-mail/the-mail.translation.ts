...
export const thMailMap = new Map<string, string>([
  [
    TheMailLabels.ADD_ADDRESS,
    `${i18n.t(`${TEXTS}.${TheMailLabels.ADD_ADDRESS}`)}`,
  ],
  ...
  [
    TheMailLabels.CONFIDENTIALITY,
    `${i18n.t(`${TEXTS}.${TheMailLabels.CONFIDENTIALITY}`)}`,
  ],
  [
    TheMailLabels.MAIL_IS_SEND,
    `${i18n.t(`${TEXTS}.${TheMailLabels.MAIL_IS_SEND}`)}`,
  ],
  [
    TheMailLabels.MAIL_SEND_ERROR,
    `${i18n.t(`${TEXTS}.${TheMailLabels.MAIL_SEND_ERROR}`)}`,
  ],
  [
    TheMailLabels.MAIL_SEND_SUCCESS,
    `${i18n.t(`${TEXTS}.${TheMailLabels.MAIL_SEND_SUCCESS}`)}`,
  ],
  [
    TheMailLabels.TEXT_FIELD_ALERT,
    `${i18n.t(`${TEXTS}.${TheMailLabels.TEXT_FIELD_ALERT}`)}`,
  ],
]);

export const theMailLabels = new I18nLabelMaker(
  thMailMap,
  TheMailLabels
).labels();
