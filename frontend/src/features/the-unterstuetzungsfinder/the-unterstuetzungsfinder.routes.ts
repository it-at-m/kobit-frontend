...
export const THE_UNTERSTUETZUNGSFINDER_ROUTE_META_INFO_TEXT_COMPLETE = `Auf dieser Seite erhalten Sie eine Empfehlung für die geeignete Anlaufstelle in Ihrer aktuellen Situation. Wenige Fragen helfen Ihnen bei der Auswahl. Auf dieser Seite erhalten Sie eine Empfehlung für die geeignete Anlaufstelle in Ihrer aktuellen Situation. Wenige Fragen helfen Ihnen bei der Auswahl. Klicken Sie dazu jeweils das Feld an, dass aus ihrer Sicht am besten zum Anliegen passt. Es werden keinerlei Informationen gespeichert. `;
