...
export const competenceToText = new Map<string, string[]>([
  [
    ...
    [
      ...
      "Das Aufeinanderprallen widerstreitender Auffassungen, Interessen oder Ähnlichem entstandenen schwierigen Situation, die zum Zerwürfnis führen kann.",
    ],
  ],
  [
    Competence.MOBBING,
    [
      "Mobbing",
      "Gezieltes Anfeinden, Schikanieren und Diskriminieren von Kolleg*innen untereinander oder durch Vorgesetzte mit dem Ziel der Ausgrenzung",
    ],
  ],
  [
  ...
  [
    ...
    [
      ...
      "Einstellung/Haltung, die sich gegen Demokratie richtet",
    ],
  ],
  [
    ...
    [
      ...
      "Jedes unerwünschte, sexuell bestimmte, körperliche, verbale oder nonverbale Verhalten, das bezweckt oder bewirkt, dass die Würde der betreffenden Person verletzt wird.",
    ],
  ],
  [
    ...
    [
      "Häusliche Gewalt",
      "Häusliche Gewalt ist jede Art körperlicher, seelischer oder sexueller Misshandlung zwischen Personen die innerhalb einer bestehenden oder im Zusammenhang mit einer früheren häuslichen Gemeinschaft oder Beziehung verübt, versucht oder angedroht wird.",
    ],
  ],
  [
    ...
    [
      "Private Probleme",
      "Familiäre und partnerschaftliche Probleme, schwere Erkrankungen, Verlust, Überforderungen im Alltag, Umbruchsituationen",
    ],
  ],
  ...
  [
    ...
    [
      "Diskriminierung aufgrund ethnischer oder rassistischer Motive, Religion oder Weltanschauung, Alter",
      "",
    ],
  ],
  ...
  [
    ...
    ["Diskriminierung aufgrund sexueller oder geschlechtlicher Identität", ""],
  ],
