...
//TODO: test fertig schreiben! ggf NWK!
/**
 ...
 * Diese Rückfrage kann z.B. über einen Dialog gelöst werden. Hierzu bietet das SaveLeave
 * ein `saveLeaveDialog` Flag an. Für genererische Dialoge bietet das SaveLeave bereits Titel und
 * Text mit an.
 *
...
@Component
export default class SaveLeave extends Vue{
    name = "saveLeaveMixin";
