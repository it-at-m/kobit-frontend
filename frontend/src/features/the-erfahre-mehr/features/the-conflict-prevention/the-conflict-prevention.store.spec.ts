import {GETTER_GET_CONFLICT_PREVENTION, theConflictPreventionStoreModule} from "@/features/the-erfahre-mehr/features/the-conflict-prevention/the-conflict-prevention.store.module";
