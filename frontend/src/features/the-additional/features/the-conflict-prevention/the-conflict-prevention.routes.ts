...
export const CONFLICT_PREVENTION_ROUTE_LINK =
  "/erfahre-mehr/konfliktpreavention";
...
export const CONFLICT_PREVENTION_ROUTE_META_INFO_TEXT =
  "Hier finden Sie Informationen, wie Sie Konflikten vorbeugen und sie zeitnah ansprechen können.";
