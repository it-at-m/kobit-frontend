import LeadershipCooperation from "@/features/the-additional/features/the-leadership-cooperation/LeadershipCooperation.type";

export const THE_LEADERSHIP_COOPERATION_MODULE_NAME =
  "theLeadershipCooperationStoreModule";
export const GETTER_GET_LEADERSHIP_COOPERATION =
  "GETTER_GET_LEADERSHIP_COOPERATION";
...
export const theLeadershipCooperationStoreModule = {
  ...
  getters: {
    [GETTER_GET_LEADERSHIP_COOPERATION](
      state: TheLeadershipCooperationStoreModuleState
