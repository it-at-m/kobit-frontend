import {
  allDownloads,
  downloadsPath,
} from "@/core/services/downloads/downloads";
import { Download } from "@/features/the-additional/features/the-downloads/download.type";
...
export const theDownloadsStoreModule = {
  ...
  getters: {
    [GET_DOWNLOADS_FILES](state: TheDownloadsModuleState): Download[] {
      ...
      return sortedDownloads.sort((a: { name: string }, b: { name: string }) =>
