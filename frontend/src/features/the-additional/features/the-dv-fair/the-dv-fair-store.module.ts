import DvFair from "@/features/the-additional/features/the-dv-fair/DvFair.type";
...
export const theDvFairStoreModule = {
  ...
  state: {
    ...
    steps: [
      {
        name: "Schritt 1",
        text: "Erstgespräch mit der unmittelbaren oder nächsthöheren Führungskraft oder Ansprechpartner_in der Anlaufstelle",
      ...
      },
      {
        ...
        header: {
          employee: {
            ...
            text: "Ihre FK führt anschließend ein Einzelgespräch mit der beschuldigten Person, um sich den Sachverhalt aus ihrer Sicht schildern zu lassen.\n",
            optional: {
              title: "Optional: Einzelgespräche mit dem/der Betroffenen",
              text: "Ihre FK entscheidet anschließend, ob sie ein weiteres Gespräch mit Ihnen führen möchte, um Ihre Einschätzungen zu besprechen.",
            },
          },
          boss: {
            title: "Einzelgespräch mit der beschuldigten Person",
            ...
            optional: {
              title: "Optional: Einzelgespräche mit dem/der Betroffenen",
              text: "Sie entscheiden, ob ein optionales Einzelgespräche mit den betroffenen Personen nötig ist. Sie können Ihre Einschätzungen besprechen, insbesondere dann, wenn Sie den Mobbingvorwurf als ungerechtfertigt ansehen.",
            },
          },
        },
      },
      {
        ...
        optionalOption: {
          text: "Bei Bedarf: Zentrale Stelle für Mediation und Konfliktmanagement",
          item: undefined,
          alert: {
            type: "info",
            showColoredBoarder: true,
