import TheEscalationSteps from "@/features/the-additional/features/the-escalation-steps/the-escalation-steps.vue";
...
export const ESCALATION_STEP_ROUTE_META_INFO_TEXT =
  "Das Phasenmodell der Eskalation nach Friedrich Glasl ermöglicht, eine Konfliktsituation zu analysieren.";
