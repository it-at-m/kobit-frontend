...
export const THE_ERFAHRE_MEHR_ROUTE_META_INFO_TEXT =
  "Hier finden Sie Informationen zum Thema „Umgang mit Konflikten“, von der DV-fair über die Eskalationsstufen nach Glasl bis hin zu FAQs.";
