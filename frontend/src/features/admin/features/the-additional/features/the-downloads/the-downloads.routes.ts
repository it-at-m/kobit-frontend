...
export const ADMIN_DOWNLOADS_ROUTE_LINK =
  "/admin/erfahre-mehr/downloads-und-links";
export const ADMIN_DOWNLOADS_ROUTE_NAME = "Downloads Bearbeiten";
export const ADMIN_DOWNLOADS_ROUTE_META_ICON = "mdi-download";
export const ADMIN_DOWNLOADS_ROUTE_META_INFO_TEXT =
  "Hier können Sie Dateien für die Download Seite anlegen und verändern.";
