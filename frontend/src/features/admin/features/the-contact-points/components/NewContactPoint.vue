  ...
  <v-container fluid>
    ...
    <v-card flat :style="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? 'border-top:1px solid #eee;' : ''"
          ...
          <v-row>
            <v-col cols="12" sm="12" md="6" lg="6" xl="6">
              <v-text-field :value="newContactPoint?.name" label="Name der Anlaufstelle"
                ...
                :counter="100" prepend-inner-icon="mdi-format-letter-case" @input="changeName" />
            </v-col>
            <v-col cols="12" sm="12" md="3" lg="3" xl="3">
              <v-text-field :value="newContactPoint?.shortCut" label="Kurzbezeichnung der Anlaufstelle"
                ...
                :counter="10" prepend-inner-icon="mdi-format-font-size-decrease" @input="changeShortCut" />
            </v-col>
            <v-col cols="12" sm="12" md="3" lg="3" xl="3">
              <v-combobox :value="newContactPoint?.departments" :label="label.addDepartment" multiple persistent-hint
                small-chips :disabled="!isCentralAdmin" @input="changeDepartment">
          ...
          <v-row class="ma-0 pa-0">
            <v-col cols="6">
              <v-textarea :value="newContactPoint?.description" label="Beschreibung"
                ...
                :counter="2000" prepend-inner-icon="mdi-format-align-left" @input="changeDescription" />
            </v-col>
            <v-col cols="6">
      ...
      <v-card-actions class="ma-0 pa-0">
        <SaveNewButton class="ml-2" :contact-point-to-save="newContactPoint" :disabled="!isFormValid"
          :file="file || undefined" @error="error" />
        <v-btn class="ml-0" color="error" @click="cancelForm">
