...
export const postContactPoint = async (
  ...
  return httpPostJson<ContactPoint>(
    "/anlaufstellen-management/anlaufstellen",
    contactPoint
  );
};

export const putContactPoint = async (
  id: string,
  contactPoint: ContactPoint,
  file?: File,
  ...
  if (file) {
    ...
    return httpPutJson<ContactPoint>(
...
export const updateCompetences = (
  itemsToUpdate: ListItemToCompetenceView[]
) => {
  return httpPutJson(
    "/anlaufstellen-management/anlaufstellen/competences",
    itemsToUpdate
  );
};
...
export const deleteContactPoint = async (contactPoint: ContactPoint) => {
  ...
  return httpDeleteJson(
    "/anlaufstellen-management/anlaufstellen/" + contactPoint.id
  );
};
