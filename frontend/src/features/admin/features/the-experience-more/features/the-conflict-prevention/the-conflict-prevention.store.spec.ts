import {GETTER_GET_CONFLICT_PREVENTION, theConflictPreventionStoreModule} from "@/features/the-experience-more/features/the-conflict-prevention/the-conflict-prevention.store.module";
