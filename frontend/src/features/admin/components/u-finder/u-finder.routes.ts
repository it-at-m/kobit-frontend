...
export const THE_UNTERSTUETZUNGSFINDER_ADMIN_ROUTE_PATH =
  "/admin/unterstuetzungsfinder";
export const THE_UNTERSTUETZUNGSFINDER_ADMIN_ROUTE_NAME =
  "Unterstützungsfinder - Admin Bereich";
